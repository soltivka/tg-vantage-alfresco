...
class Oauth2Auth extends alfrescoApiClient_1.AlfrescoApiClient {
    ...
    pollingRefreshToken() {
        this.refreshTokenIntervalPolling = setInterval(() => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            try {
    ...
    exchangeTicketListener(alfrescoApi) {
        this.on('token_issued', () => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
